...
public class MessageApi {
     ...
     */
    public okhttp3.Call getAllMessagesOfConversationCall(List<UserProfileDTO> userProfileDTO, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllMessagesOfConversationValidateBeforeCall(List<UserProfileDTO> userProfileDTO, final ApiCallback _callback) throws ApiException {
     ...
     */
    public List<Message> getAllMessagesOfConversation(List<UserProfileDTO> userProfileDTO) throws ApiException {
        ApiResponse<List<Message>> localVarResp = getAllMessagesOfConversationWithHttpInfo(userProfileDTO);
     ...
     */
    public ApiResponse<List<Message>> getAllMessagesOfConversationWithHttpInfo(List<UserProfileDTO> userProfileDTO) throws ApiException {
     ...
     */
    public okhttp3.Call getAllMessagesOfConversationAsync(List<UserProfileDTO> userProfileDTO, final ApiCallback<List<Message>> _callback) throws ApiException {
    ...
    /**
     * Build call for getLastMessagesOfConversation
     * @param userProfileDTO  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getLastMessagesOfConversationCall(List<UserProfileDTO> userProfileDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLastMessagesOfConversationValidateBeforeCall(List<UserProfileDTO> userProfileDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'userProfileDTO' is set
        if (userProfileDTO == null) {
            throw new ApiException("Missing the required parameter 'userProfileDTO' when calling getLastMessagesOfConversation(Async)");
        }

        return getLastMessagesOfConversationCall(userProfileDTO, _callback);
     ...
     */
    public List<Message> getLastMessagesOfConversation(List<UserProfileDTO> userProfileDTO) throws ApiException {
        ApiResponse<List<Message>> localVarResp = getLastMessagesOfConversationWithHttpInfo(userProfileDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<Message>> getLastMessagesOfConversationWithHttpInfo(List<UserProfileDTO> userProfileDTO) throws ApiException {
        okhttp3.Call localVarCall = getLastMessagesOfConversationValidateBeforeCall(userProfileDTO, null);
        Type localVarReturnType = new TypeToken<List<Message>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getLastMessagesOfConversationAsync(List<UserProfileDTO> userProfileDTO, final ApiCallback<List<Message>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLastMessagesOfConversationValidateBeforeCall(userProfileDTO, _callback);
        Type localVarReturnType = new TypeToken<List<Message>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
